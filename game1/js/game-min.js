var bgmusic = new MusicObject("audio/bg.mp3", true);
var egret;
(function(b) {
	var e = function() {
			function b() {
...
(function(b) {
	var e = function(b) {
			...
			a.prototype.push = function(d) {
				var k = this.objectPool; - 1 == k.indexOf(d) && (k.push(d), this._length++, 0 == this.frameCount && (this.frameCount = this.autoDisposeTime, a._callBackList.push(this)))
			};
...
(function(b) {
	function e() {
		for (var b = document.createElement("div").style, a = ["t", "webkitT", "msT", "MozT", "OT"], d = 0; d < a.length; d++) if (a[d] + "ransform" in b) return a[d];
		return a[0]
	}
	b.header = "";
	b.getHeader = e;
...
(function(b) {
	var e = function(c) {
			...
			a._dispatchByTarget = function(d, a, n, c, e, f) {
				...
				m._bubbles = e;
				m._cancelable = f;
				if (c) for (var p in c) m[p] = c[p], null !== m[p] && (c[p] = null);
				d = a.dispatchEvent(m);
				h.push(m);
				return d
			};
	...
	var e = function(c) {
			...
			a.prototype.removeEventListener = function(d, a, b, c) {
				...
				if (c = c ? this._captureEventsMap : this._eventsMap) {
					var e = c[d];
					e && (this._removeEventBin(e, a, b), 0 == e.length && delete c[d])
				}
			};
...
(function(b) {
	var e = function(c) {
			...
			a.prototype.broadcastRender = function() {
				...
				for (var a = b.DisplayObject._renderCallBackList.concat(), n = a.length, c = 0; c < n; c++) {
					var e = a[c],
						f = e.display;
					d._target = f;
					d._currentTarget = f;
...
(function(b) {
	...
	b.getDefinitionByName = function(b) {
		...
		var a = e[b];
		if (a) return a;
		for (var d = b.split("."), k = d.length, a = __global, n = 0; n < k; n++) if (a = a[d[n]], !a) return null;
		return e[b] = a
	}
})(egret || (egret = {}));
...
(function(b) {
	var e = function(c) {
			...
			a.prototype.append = function(d, a, b, c, e, f) {
				var h = this.a,
					m = this.b,
					p = this.c,
					q = this.d;
			...
			a.prototype.prependTransform = function(d, a, n, c, e, f, h, m, p) {
				...
				f || h ? (this.prepend(q * n, e * n, -e * c, q * c, 0, 0), this.prepend(b.NumberUtils.cos(h), b.NumberUtils.sin(h), -b.NumberUtils.sin(f), b.NumberUtils.cos(f), d, a)) : this.prepend(q * n, e * n, -e * c, q * c, d, a);
				return this
			};
...
(function(b) {
	var e = function(c) {
			...
			a.prototype.parserXML = function(d) {
				...
				this._isSupportDOMParser ? a = this._parser.parseFromString(d, "text/xml") : (a = new ActiveXObject("Microsoft.XMLDOM"), a.async = "false", a.loadXML(d));
...
(function(b) {
	var e = function(d) {
			...
			k.prototype.setDesignSize = function(d, a, k) {
				...
				k && (b.Logger.warning("该方法目前不应传入 resolutionPolicy 参数，请在 docs/1.0_Final_ReleaseNote中查看如何升级"), this._setResolutionPolicy(k))
			};
...
(function(b) {
	var e = function(c) {
			...
			a.prototype.removeEventListener = function(d, k, n, e) {
				void 0 === e && (e = !1);
			...
			a.prototype._dispatchPropagationEvent = function(d, a, b) {
				...
				d._eventPhase = 2;
				f._notifyListener(d);
				if (!d._isPropagationStopped && !d._isPropagationImmediateStopped) for (c = 3, e = 1; e < b && (f = a[e], d._currentTarget = f, d._target = this, d._eventPhase = c, f._notifyListener(d), !d._isPropagationStopped && !d._isPropagationImmediateStopped); e++);
			};
			a.prototype.willTrigger = function(d) {
				for (var a = this; a;) {
...
(function(b) {
	var e = function(c) {
			...
			a.prototype.doSetChildIndex = function(d, a) {
			...
			a.prototype._doAddChild = function(d, k, c) {
				void 0 === c && (c = !0);
				if (d == this) return d;
				if (0 > k || k > this._children.length) return b.Logger.fatal("提供的索引超出范围"), d;
				var e = d._parent;
				...
				if (this._stage) for (d._onAddToStage(), k = a.__EVENT__ADD_TO_STAGE_LIST; 0 < k.length;) k.shift().dispatchEventWith(b.Event.ADDED_TO_STAGE);
				d._setDirty();
				this._setSizeDirty();
				return d
			};
				...
				for (var d = 0, a = 0, c = 0, e = 0, g = this._children.length, f = 0; f < g; f++) {
					...
					if (h._visible) {
						var m = h.getBounds(b.Rectangle.identity, !1),
							...
							m = m.height,
							h = h._getMatrix(),
							h = b.DisplayObject.getTransformBounds(b.Rectangle.identity.initialize(p, q, r, m), h),
							p = h.x,
							q = h.y,
							r = h.width + h.x,
							h = h.height + h.y;
			...
			a.prototype.getChildByName = function(d) {
				for (var a = this._children, b = a.length, c, e = 0; e < b; e++) if (c = a[e], c.name == d) return c;
				return null
			};
...
(function(b) {
	var e = function(c) {
			...
			a.prototype.setContent = function(d) {
				this._content !== d && (this.removeContent(), d && (this._content = d, c.prototype.addChild.call(this, d), this._addEvents()))
			};
			...
			a.prototype.setScrollPosition = function(d, a, b) {
				void 0 === b && (b = !1);
				if (!b || 0 != d || 0 != a) if (b || this._scrollTop != d || this._scrollLeft != a) {
					if (b) {
			...
			a.prototype.setScrollTop = function(d, a) {
				void 0 === a && (a = 0);
				var c = Math.min(this.getMaxScrollTop(), Math.max(d, 0));
			...
			a.prototype.getAnimationDatas = function(d, a, b) {
				var c = Math.abs(d),
					e = 0,
					f = a + 500 * d;
				if (0 > f || f > b) for (f = a; Infinity != Math.abs(d) && 0.02 < Math.abs(d);) f += d, d = 0 > f || f > b ? 0.998 * d * 0.95 : 0.998 * d, e++;
...
(function(b) {
	var e = function(c) {
			...
			a.prototype._render = function(d) {
				var b = this._texture;
				b ? (this._texture_to_render = b, a._drawBitmap(d, this._hasWidthSet ? this._explicitWidth : b._textureWidth, this._hasHeightSet ? this._explicitHeight : b._textureHeight, this)) : this._texture_to_render = null
			};
				...
				if (g) {
					...
					if ("scale" == e.fillMode) {
						...
						if (m && f - m.width < b && h - m.height < c) a.drawScale9GridImage(d, e, m, b, c);
							...
							p = Math.round(p * c);
							c = Math.round(r * c);
							a.renderFilter.drawImage(d, e, g._bitmapX, g._bitmapY, q, r, m, p, b, c)
						}
			...
			a.drawScale9GridImage = function(d, a, c, e, g) {
				...
				if (f && c) {
					...
					var m = q + c.x,
						...
						s = g - (s - c.bottom),
						t = e - (t - c.right);
					h.drawImage(d, a, q / f, r / f, c.x, c.y, u, v, c.x, c.y);
...
(function(b) {
	var e = function(c) {
			...
			Object.defineProperty(a.prototype, "spriteSheet", {
				...
				set: function(d) {
					this._spriteSheet != d && (this._spriteSheet = d, this._spriteSheetChanged = !0, this._setSizeDirty())
				},
				enumerable: !0,
				configurable: !0
			});
...
(function(b) {
	var e = function() {
			...
			b.prototype.lineStyle = function(a, d, b, c, e, g, f, h) {};
				...
				for (var m = 0; m < d.length; m++) {
					...
					for (var q = p.text.toString().split(/(?:\r\n|\r|\n)/), r = 0; r < q.length; r++) {
						...
						if ("" != q[r]) {
							...
							if (this._hasWidthSet) if (e + t <= this._explicitWidth) h.elements.push({
								width: t,
								text: q[r],
								style: p.style
							}), e += t;
			...
			a.prototype.drawText = function(d) {
				...
				if (a) {
					...
					var c = this._hasWidthSet ? this._explicitWidth : this._textMaxWidth,
						...
						g = 0,
						f = 0;
					if (this._hasHeightSet) if (e < this._explicitHeight) {
						var h = 0;
...
(function(b) {
	var e = function(c) {
			...
			a.prototype._updateTransform = function() {
				...
				if (this._isFirst || d != h.a || a != h.b || c != h.c || e != h.d || g != h.tx || f != h.ty) {
					this._isFirst = !1;
					d = this._text.localToGlobal();
...
(function(b) {
	...
	var c = function() {
			...
			a.prototype.playNextFrame = function(a) {
				...
				this._currentFrameIndex == this._totalFrame && (this._currentFrameIndex = 0, c.action != b.Event.COMPLETE && this.movieClip.dispatchEventWith(b.Event.COMPLETE))
			};
			a.prototype.getTexture = function(a) {
...
(function(b) {
	var e = function(c) {
			...
			a.prototype.drawText = function(a, b, c, e, g, f) {
				this.profiler.onDrawImage()
			};
...
(function(b) {
	var e = function(c) {
			...
			a.prototype.onTouchEnd = function(a, c, e) {
				var l = this.touchingIdentifiers.indexOf(e); - 1 != l && (this.touchingIdentifiers.splice(l, 1), l = b.MainContext.instance.stage.hitTest(a, c)) && (a = this.getTouchData(e, a, c), delete this.touchDownTarget[e], e = a.beginTarget, a.target = l, this.dispatchEvent(b.TouchEvent.TOUCH_END, a), e == l ? this.dispatchEvent(b.TouchEvent.TOUCH_TAP, a) : a.beginTarget && (a.target = a.beginTarget, this.dispatchEvent(b.TouchEvent.TOUCH_RELEASE_OUTSIDE, a)), delete this._currentTouchTarget[a.identifier])
			};
			return a
		}(b.HashObject);
	b.TouchContext = e;
...
(function(b) {
	var e = function(c) {
			...
			a.prototype.$ = function(d) {
				var c = document;
				if (d = d instanceof HTMLElement ? d : c.querySelector(d)) d.find = d.find || this.$, d.hasClass = d.hasClass ||
				function(a) {
				...
				function(a) {
					...
					return this
				}, d.removeClass = d.removeClass ||
				function(a) {
					this.hasClass(a) && (this.className = this.className.replace(a, ""));
					return this
				}, d.remove = d.remove ||
				function() {}, d.appendTo = d.appendTo ||
				function(a) {
					a.appendChild(this);
					return this
...
(function(b) {
	var e = function() {
			...
			c.parseNode = function(a) {
				...
				b = a.childNodes;
				e = b.length;
				for (l = 0; l < e; l++) if (g = c.parseNode(b[l])) d.children || (d.children = []), g.parent = d, d.children.push(g);
			...
			c.findByPath = function(a, d, b) {
				...
				if (a = a.children) for (var g = a.length, f = 0; f < g; f++) {
					var h = a[f];
					h.localName == l && (e ? b.push(h) : c.findByPath(h, d, b))
				}
			};
...
(function(b) {
	var e = function(c) {
			...
			a.removeTweens = function(d) {
				if (d.tween_count) {
					for (var b = a._tweens, c = b.length - 1; 0 <= c; c--) b[c]._target == d && (b[c].paused = !0, b.splice(c, 1));
					d.tween_count = 0
				}
			};
			a.pauseTweens = function(a) {
				if (a.tween_count) for (var c = b.Tween._tweens, e = c.length - 1; 0 <= e; e--) c[e]._target == a && (c[e].paused = !0)
			};
			a.resumeTweens = function(a) {
				if (a.tween_count) for (var c = b.Tween._tweens, e = c.length - 1; 0 <= e; e--) c[e]._target == a && (c[e].paused = !1)
			};
			a.tick = function(d, b) {
				void 0 === b && (b = !1);
				for (var c = a._tweens.concat(), e = c.length - 1; 0 <= e; e--) {
					var g = c[e];
					b && !g.ignoreGlobalPause || g.paused || g.tick(g._useTicks ? 1 : d)
				}
			};
			a._register = function(d, c) {
				...
				else for (e && e.tween_count--, e = l.length; e--;) if (l[e] == d) {
					l.splice(e, 1);
					break
				}
			};
			...
			a.prototype.initialize = function(d, b, c) {
				this._target = d;
				b && (this._useTicks = b.useTicks, this.ignoreGlobalPause = b.ignoreGlobalPause, this.loop = b.loop, b.onChange && this.addEventListener("change", b.onChange, b.onChangeObj), b.override && a.removeTweens(d));
				this.pluginData = c || {};
				this._curQueueProps = {};
			...
			a.prototype.setPosition = function(a, b) {
				...
				if (this._target) if (e) this._updateTargetProps(null, 1);
			...
			a.prototype._appendQueueProps = function(d) {
				var b, c, e, g, f, h;
				for (h in d) if (void 0 === this._initQueueProps[h]) {
					c = this._target[h];
					if (b = a._plugins[h]) for (e = 0, g = b.length; e < g; e++) c = b[e].init(this, h, c);
					this._initQueueProps[h] = this._curQueueProps[h] = void 0 === c ? null : c
				}
				for (h in d) {
					c = this._curQueueProps[h];
					if (b = a._plugins[h]) for (f = f || {}, e = 0, g = b.length; e < g; e++) b[e].step && b[e].step(this, h, c, d[h], f);
	...
	var e = function() {
			...
			c.getElasticIn = function(a, d) {
				...
				return function(c) {
					...
					return -(a * Math.pow(2, 10 * (c -= 1)) * Math.sin((c - e) * b / d))
				}
			};
...
(function(b) {
	var e = function() {
			...
			c.prototype.createGroup = function(a, d, b) {
				...
				b = this.groupDic;
				for (var c = [], e = d.length, g = 0; g < e; g++) {
					var f = d[g],
						h = b[f];
					if (h) for (var f = h.length, m = 0; m < f; m++) {
			...
			c.prototype.parseConfig = function(a, d) {
				if (a) {
					var b = a.resources;
					if (b) for (var c = b.length, e = 0; e < c; e++) {
						var g = b[e],
							f = g.url;
						f && -1 == f.indexOf("://") && (g.url = d + f);
						this.addItemToKeyMap(g)
					}
					if (b = a.groups) for (c = b.length, e = 0; e < c; e++) {
	...
	var e = function(c) {
			...
			a.prototype.onItemComplete = function(a) {
				...
				if (!a.loaded) {
					...
					if (e > this.maxRetryTimes) delete this.retryTimesDic[a.name], b.ResourceEvent.dispatchResourceEvent(this.resInstance, b.ResourceEvent.ITEM_LOAD_ERROR, c, a);
					else {
...
(function(b) {
	var e = function(c) {
			...
			a.prototype.analyzeData = function(a, b) {
				...
				if (!this.fileDic[c] && b) {
					...
					if ("string" == typeof b) {
						...
						e && (this.sheetMap[c] = e, a.loaded = !1, a.url = this.getRelativePath(a.url, e.file))
			...
			a.prototype.parseSpriteSheet = function(a, b, c) {
				...
				for (f in b) {
					var h = b[f];
					a = e.createTexture(f, h.x, h.y, h.w, h.h, h.offX, h.offY, h.sourceW, h.sourceH);
...
(function(b) {
	var e = function(b) {
			...
			a.prototype.getTexturePath = function(a, b) {
				var c = "",
					e = b.split("\n")[2],
					g = e.indexOf('file="'); - 1 != g && (e = e.substring(g + 6), g = e.indexOf('"'), c = e.substring(0, g));
				a = a.split("\\").join("/");
				g = a.lastIndexOf("/");
...
(function(b) {
	...
	b.getResByUrl = function(a, b, e, n) {
		void 0 === n && (n = "");
...
(function(b) {
	...
	b.drawCircle = function(b, a, d) {
		this.commandQueue.push(new e(function(a, b, d) {
...
(function(b) {
	var e = function(c) {
			...
			a.prototype.drawRepeatImage = function(a, c, e, l, g, f, h, m, p, q) {
				...
				l *= q;
				for (g *= q; f < m; f += l) for (var r = h; r < p; r += g) {
			...
			a.prototype.drawImage = function(a, b, c, e, g, f, h, m, p, q) {
				void 0 === q && (q = void 0);
				if (!this.contextLost) if (void 0 !== q) this.drawRepeatImage(a, b, c, e, g, f, h, m, p, q);
				else {
...
(function(b) {
	var e = function(c) {
			...
			a.prototype.proceed = function(a) {
				function c() {
					if (4 == l.readyState) if (l.status != a._status && (a._status = l.status, b.HTTPStatusEvent.dispatchHTTPStatusEvent(a, l.status)), 400 <= l.status || 0 == l.status) b.IOErrorEvent.dispatchIOErrorEvent(a);
					else {
						switch (a.dataFormat) {
				...
				if (a.dataFormat == b.URLLoaderDataFormat.TEXTURE) this.loadTexture(a);
					...
					e.method != b.URLRequestMethod.GET && e.data ? e.data instanceof b.URLVariables ? (l.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), l.send(e.data.toString())) : (l.setRequestHeader("Content-Type", "multipart/form-data"), l.send(e.data)) : l.send()
				}
			};
...
(function(b) {
	var e = function(c) {
			...
			a.prototype.getLocation = function(a, c) {
				...
				null != c.pageX ? (e = c.pageX, l = c.pageY) : (g -= document.body.scrollLeft, f -= document.body.scrollTop, e = c.clientX, l = c.clientY);
...
var XiaobinDrager = function() {
		...
		b.onTouchMove = function(e) {
			!0 != b.gameOver && !0 == b.canMove && b.theMc && (b.theMc.x = e.stageX - b.localX, b.theMc.y = e.stageY - b.localY)
		};
		b.onTouchBegin = function(e) {
			if (!0 != b.gameOver) for (var c = this.mcArr.length - 1; 0 <= c; c--) if (this.mcArr[c].hitTestPoint(e.stageX, e.stageY, !0)) {
		...
		b.onTouchEnd = function(e) {
			...
			console.log("onTouchEnd", b.score)
		};
		b.gameOver = !1;
		b.sec = 0;
		b.score = 0;
...
function(b, e) {
	...
	e.prototype.ats = function(b) {
		...
		this.addChild(b);
		b.text = "你拯救小羊获得了  " + XiaobinDrager.score + "  分!";
		window.parent.updateCore && window.parent.updateCore(XiaobinDrager.score)
		b.width = this.stageW;
		b.y = 150;
		b.size = 22;
		b.lineSpacing = 10;
	...
	e.prototype.doReplay = function(b) {
		...
		if (!window.parent.checkGameCount()) {
			return window.alert("次数已用完")
		}
		window.parent.decrumentGameCount()
...
function(b, e) {
	...
	e.prototype.startGame = function(b) {
		...
		b.size = 20;
		b.x = this.stageW / 2 - b.width / 2;
		b.y = this.startBtn.y + this.startBtn.height - 120;
...
function(b, e) {
	...
	e.prototype.ats = function(b) {
		...
		this.addChild(b);
		b = XiaobinTool.dn;
		"3366.com" != b.slice(b.length - 8, b.length) && "m.3366.com" != b && "mt.3366.com" != b && "www.3366.com" != b && "182.254.208.115" != b && "localhost" != b && "???" != b && (b = new egret.Timer(3E4, 1), b.addEventListener(egret.TimerEvent.TIMER_COMPLETE, this.linkMe, this), b.start());
		this.creatHuoji();
		...
		this.panel.x = this.stageW - this.panel.width - 20;
		this.panel.y = 10;
	...
	e.prototype.makePost = function() {};
	e.prototype.loop = function(b) {
		!0 != XiaobinDrager.gameOver && (this.count++, this.makeHuojiRun(), this.count == this.maxCount && (this.count = 0, this.creatHuoji(null), this.maxCount = 40 < this.maxCount ? this.maxCount - 10 : 60 * (Math.floor(4 * Math.random()) + 1)))
	};
	...
	e.prototype.make3366 = function() {
		bgmusic.pause();
		dp_share(this.scoreNum);
		dp_submitScore(-1, this.scoreNum);
	};
	...
	e.prototype.onTouchEnd = function(b) {
		...
		if (!(530 > b.stageY) && null != XiaobinDrager.theMc) for (b = 0; b < this.huojiArr.length; b++) if (this.huojiArr[b] == XiaobinDrager.theMc) {
	...
	e.prototype.makeHuoji = function(b, a) {
		var d = XiaobinTool.creatMovieClip("HuojiMc_json", "HuojiMc_png", "leftRun");
		this.addChild(d);
...
function(b, e) {
	...
	e.prototype.setProgress = function(b, a) {
		this.textField.text = "Loading..." + Math.floor(b / a * 100) + "%";
...
function(b, e) {
	...
	e.prototype.onResourceLoadComplete = function(b) {
		"preload" == b.groupName && (this.stage.removeChild(this.loadingView), RES.removeEventListener(RES.ResourceEvent.GROUP_COMPLETE, this.onResourceLoadComplete, this), RES.removeEventListener(RES.ResourceEvent.GROUP_PROGRESS, this.onResourceProgress, this), this.createGameScene(), this.makeDataPost())
	};
